          ...
          <div class="cart">
            <div class="cart_container d-flex flex-row align-items-center justify-content-end">
              ...
              <div class="cart_content">
                <div class="cart_text"><a href="<?php echo base_url('welcome/cart'); ?>">Cart</a></div>
        ...
        <div class="main_nav_content d-flex flex-row">
          ...
          <div class="main_nav_menu ml-auto">
            <ul class="standard_dropdown main_nav_dropdown">
              <li><a href="<?php echo base_url('welcome/index');?>">Home<i class="fas fa-chevron-down"></i></a></li>
              <li><a href="<?php echo base_url('welcome/shop');?>">Shop<i class="fas fa-chevron-down"></i></a></li>
              <li><a href="<?php echo base_url('welcome/product');?>">Product<i class="fas fa-chevron-down"></i></a></li>
              <li><a href="<?php echo base_url('welcome/blog');?>">Blog<i class="fas fa-chevron-down"></i></a></li>
